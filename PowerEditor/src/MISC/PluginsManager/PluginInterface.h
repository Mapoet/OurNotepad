...
// You should implement (or define an empty function body) those functions which are called by OurNotepad plugin manager
...
// This API return always true now, since OurNotepad isn't compiled in ANSI mode anymore
