...
#define NPPMSG  (WM_USER + 1000)
	...
	// Return: menu handle (HMENU) of choice (plugin menu handle or OurNotepad main menu handle)
	...
	// to access all the OurNotepad menu command items
	...
	// Check to see if loading plugins from "%APPDATA%\..\Local\OurNotepad\plugins" is allowed.

	#define NPPM_GETCURRENTVIEW    (NPPMSG + 88)
	// INT NPPM_GETCURRENTVIEW(0, 0)
	// Return: current edit view of OurNotepad. Only 2 possible values: 0 = Main, 1 = Secondary
...
#define NPPN_FIRST 1000
	#define NPPN_READY (NPPN_FIRST + 1) // To notify plugins that all the procedures of launchment of OurNotepad are done.
	...
	#define NPPN_SHUTDOWN (NPPN_FIRST + 9) // To notify plugins that OurNotepad is about to be shutdowned.
